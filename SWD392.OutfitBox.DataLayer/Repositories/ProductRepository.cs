...
namespace SWD392.OutfitBox.DataLayer.Repositories
{
    public class ProductRepository : BaseRepository<Product>, IProductRepository
    {
        ...
        public async Task<List<Product>> GetList(int? pageIndex = null, int? pageSize = null, string sorted = "", string orders = "", string name = "", List<int>? idBrand = null, List<int>? idCategory = null, int? status = null, double? maxMoney = null, double? minMoney = null, bool? isFeatured = null)
        {
            var predicate = PredicateBuilder.New<Product>();

            if(isFeatured != null)
            {
                predicate = predicate.And(x => x.IsFeatured == isFeatured.Value);
            }
