...
namespace SWD392.OutfitBox.DataLayer.Migrations
{
    ...
    [Migration("20240709055354_seed1")]
    partial class seed1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SWD392.OutfitBox.DataLayer.Entities.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Picture = "",
                            Status = 1,
                            Time = new DateTime(2024, 7, 9, 12, 53, 54, 547, DateTimeKind.Local).AddTicks(5798)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            Picture = "",
                            Status = 1,
                            Time = new DateTime(2024, 7, 9, 12, 53, 54, 547, DateTimeKind.Local).AddTicks(5814)
                        },
                        new
                        {
                            Id = 3,
                            ...
                            Picture = "",
                            Status = 1,
                            Time = new DateTime(2024, 7, 9, 12, 53, 54, 547, DateTimeKind.Local).AddTicks(5816)
                        },
                        new
                        {
                            Id = 4,
                            ...
                            Picture = "",
                            Status = 1,
                            Time = new DateTime(2024, 7, 9, 12, 53, 54, 547, DateTimeKind.Local).AddTicks(5817)
                        });
                });
            ...
            modelBuilder.Entity("SWD392.OutfitBox.DataLayer.Entities.CustomerPackage", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CustomerId = 1,
                            DateFrom = new DateTime(2024, 7, 9, 12, 53, 54, 547, DateTimeKind.Local).AddTicks(5870),
                            DateTo = new DateTime(2024, 8, 8, 12, 53, 54, 547, DateTimeKind.Local).AddTicks(5871),
                            PackageId = 1,
            ...
            modelBuilder.Entity("SWD392.OutfitBox.DataLayer.Entities.Deposit", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AmountMoney = 20.0,
                            CustomerId = 1,
                            Date = new DateTime(2024, 7, 9, 12, 53, 54, 547, DateTimeKind.Local).AddTicks(5934),
                            Type = "Khuyen Mai"
                        });
                });
            ...
            modelBuilder.Entity("SWD392.OutfitBox.DataLayer.Entities.Image", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ID = 19,
                            IdProduct = 10,
                            Link = "https://down-vn.img.susercontent.com/file/sg-11134201-7rd6z-lvwmeuz0ecor6b"
                        },
                        new
                        {
                            ID = 20,
                        ...
                        new
                        {
                            ID = 21,
                            IdProduct = 9,
                            Link = "https://down-vn.img.susercontent.com/file/vn-11134201-7qukw-li6s4n1o9lhoee"
                        },
                        new
                        {
                            ID = 22,
                            IdProduct = 9,
                            Link = "https://down-vn.img.susercontent.com/file/vn-11134201-7qukw-li6s4mywdnnwd5"
                        },
                        new
                        {
                            ID = 23,
            ...
            modelBuilder.Entity("SWD392.OutfitBox.DataLayer.Entities.Transaction", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amount = 0.0,
                            DateTransaction = new DateTime(2024, 7, 9, 12, 53, 54, 547, DateTimeKind.Local).AddTicks(5909),
                            DepositId = 1,
                            Paymethod = "",
                            Status = 0,
                            WalletId = 1
