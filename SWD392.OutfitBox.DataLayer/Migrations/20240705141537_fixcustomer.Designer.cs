...
namespace SWD392.OutfitBox.DataLayer.Migrations
{
    ...
    [Migration("20240705141537_fixcustomer")]
            ...
            modelBuilder.Entity("SWD392.OutfitBox.DataLayer.Entities.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Picture = "",
                            Status = 1,
                            Time = new DateTime(2024, 7, 5, 21, 15, 37, 414, DateTimeKind.Local).AddTicks(7038)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            Picture = "",
                            Status = 1,
                            Time = new DateTime(2024, 7, 5, 21, 15, 37, 414, DateTimeKind.Local).AddTicks(7055)
                        },
                        new
                        {
                            Id = 3,
                            ...
                            Picture = "",
                            Status = 1,
                            Time = new DateTime(2024, 7, 5, 21, 15, 37, 414, DateTimeKind.Local).AddTicks(7056)
                        },
                        new
                        {
                            Id = 4,
                            ...
                            Picture = "",
                            Status = 1,
                            Time = new DateTime(2024, 7, 5, 21, 15, 37, 414, DateTimeKind.Local).AddTicks(7057)
                        });
                });
            ...
            modelBuilder.Entity("SWD392.OutfitBox.DataLayer.Entities.CustomerPackage", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CustomerId = 1,
                            DateFrom = new DateTime(2024, 7, 5, 21, 15, 37, 414, DateTimeKind.Local).AddTicks(7106),
                            DateTo = new DateTime(2024, 8, 4, 21, 15, 37, 414, DateTimeKind.Local).AddTicks(7106),
                            PackageId = 1,
            ...
            modelBuilder.Entity("SWD392.OutfitBox.DataLayer.Entities.Deposit", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AmountMoney = 20.0,
                            CustomerId = 1,
                            Date = new DateTime(2024, 7, 5, 21, 15, 37, 414, DateTimeKind.Local).AddTicks(7198),
                            Type = "Khuyen Mai"
                        });
                });
            ...
            modelBuilder.Entity("SWD392.OutfitBox.DataLayer.Entities.Transaction", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amount = 0.0,
                            DateTransaction = new DateTime(2024, 7, 5, 21, 15, 37, 414, DateTimeKind.Local).AddTicks(7140),
                            DepositId = 1,
                            Paymethod = "",
                            Status = 0,
                            WalletId = 1
