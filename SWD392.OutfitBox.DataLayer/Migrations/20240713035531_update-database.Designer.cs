...
namespace SWD392.OutfitBox.DataLayer.Migrations
{
    ...
    [Migration("20240713035531_update-database")]
            ...
            modelBuilder.Entity("SWD392.OutfitBox.DataLayer.Entities.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Picture = "",
                            Status = 1,
                            Time = new DateTime(2024, 7, 13, 10, 55, 30, 511, DateTimeKind.Local).AddTicks(6678)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            Picture = "",
                            Status = 1,
                            Time = new DateTime(2024, 7, 13, 10, 55, 30, 511, DateTimeKind.Local).AddTicks(6694)
                        },
                        new
                        {
                            Id = 3,
                            ...
                            Picture = "",
                            Status = 1,
                            Time = new DateTime(2024, 7, 13, 10, 55, 30, 511, DateTimeKind.Local).AddTicks(6697)
                        },
                        new
                        {
                            Id = 4,
                            ...
                            Picture = "",
                            Status = 1,
                            Time = new DateTime(2024, 7, 13, 10, 55, 30, 511, DateTimeKind.Local).AddTicks(6699)
                        });
                });
            ...
            modelBuilder.Entity("SWD392.OutfitBox.DataLayer.Entities.CustomerPackage", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CustomerId = 1,
                            DateFrom = new DateTime(2024, 7, 13, 10, 55, 30, 511, DateTimeKind.Local).AddTicks(6763),
                            DateTo = new DateTime(2024, 8, 12, 10, 55, 30, 511, DateTimeKind.Local).AddTicks(6764),
                            PackageId = 1,
            ...
            modelBuilder.Entity("SWD392.OutfitBox.DataLayer.Entities.Deposit", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AmountMoney = 20.0,
                            CustomerId = 1,
                            Date = new DateTime(2024, 7, 13, 10, 55, 30, 511, DateTimeKind.Local).AddTicks(6852),
                            Type = "Khuyen Mai"
                        });
                });
            ...
            modelBuilder.Entity("SWD392.OutfitBox.DataLayer.Entities.Transaction", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amount = 0.0,
                            DateTransaction = new DateTime(2024, 7, 13, 10, 55, 30, 511, DateTimeKind.Local).AddTicks(6815),
                            DepositId = 1,
                            Paymethod = "",
                            Status = 0,
                            WalletId = 1
