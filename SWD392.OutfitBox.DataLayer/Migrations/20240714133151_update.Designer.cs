...
namespace SWD392.OutfitBox.DataLayer.Migrations
{
    ...
    [Migration("20240714133151_update")]
            ...
            modelBuilder.Entity("SWD392.OutfitBox.DataLayer.Entities.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Picture = "",
                            Status = 1,
                            Time = new DateTime(2024, 7, 14, 20, 31, 51, 190, DateTimeKind.Local).AddTicks(122)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            Picture = "",
                            Status = 1,
                            Time = new DateTime(2024, 7, 14, 20, 31, 51, 190, DateTimeKind.Local).AddTicks(142)
                        },
                        new
                        {
                            Id = 3,
                            ...
                            Picture = "",
                            Status = 1,
                            Time = new DateTime(2024, 7, 14, 20, 31, 51, 190, DateTimeKind.Local).AddTicks(144)
                        },
                        new
                        {
                            Id = 4,
                            ...
                            Picture = "",
                            Status = 1,
                            Time = new DateTime(2024, 7, 14, 20, 31, 51, 190, DateTimeKind.Local).AddTicks(147)
                        });
                });
            ...
            modelBuilder.Entity("SWD392.OutfitBox.DataLayer.Entities.CustomerPackage", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CustomerId = 1,
                            DateFrom = new DateTime(2024, 7, 14, 20, 31, 51, 190, DateTimeKind.Local).AddTicks(225),
                            DateTo = new DateTime(2024, 8, 13, 20, 31, 51, 190, DateTimeKind.Local).AddTicks(226),
            ...
            modelBuilder.Entity("SWD392.OutfitBox.DataLayer.Entities.Deposit", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AmountMoney = 20.0,
                            CustomerId = 1,
                            Date = new DateTime(2024, 7, 14, 20, 31, 51, 190, DateTimeKind.Local).AddTicks(339),
                            Type = "Khuyen Mai"
                        });
                });
            ...
            modelBuilder.Entity("SWD392.OutfitBox.DataLayer.Entities.Transaction", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amount = 0.0,
                            DateTransaction = new DateTime(2024, 7, 14, 20, 31, 51, 190, DateTimeKind.Local).AddTicks(280),
                            DepositId = 1,
                            Paymethod = "",
                            Status = 0,
                            WalletId = 1
