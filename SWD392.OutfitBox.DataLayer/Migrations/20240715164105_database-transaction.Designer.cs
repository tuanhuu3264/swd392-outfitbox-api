...
namespace SWD392.OutfitBox.DataLayer.Migrations
{
    ...
    [Migration("20240715164105_database-transaction")]
    partial class databasetransaction
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SWD392.OutfitBox.DataLayer.Entities.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Picture = "",
                            Status = 1,
                            Time = new DateTime(2024, 7, 15, 23, 41, 4, 819, DateTimeKind.Local).AddTicks(8572)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            Picture = "",
                            Status = 1,
                            Time = new DateTime(2024, 7, 15, 23, 41, 4, 819, DateTimeKind.Local).AddTicks(8598)
                        },
                        new
                        {
                            Id = 3,
                            ...
                            Picture = "",
                            Status = 1,
                            Time = new DateTime(2024, 7, 15, 23, 41, 4, 819, DateTimeKind.Local).AddTicks(8599)
                        },
                        new
                        {
                            Id = 4,
                            ...
                            Picture = "",
                            Status = 1,
                            Time = new DateTime(2024, 7, 15, 23, 41, 4, 819, DateTimeKind.Local).AddTicks(8600)
                        });
                });
            ...
            modelBuilder.Entity("SWD392.OutfitBox.DataLayer.Entities.CustomerPackage", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CustomerId = 1,
                            DateFrom = new DateTime(2024, 7, 15, 23, 41, 4, 819, DateTimeKind.Local).AddTicks(8664),
                            DateTo = new DateTime(2024, 8, 14, 23, 41, 4, 819, DateTimeKind.Local).AddTicks(8665),
            ...
            modelBuilder.Entity("SWD392.OutfitBox.DataLayer.Entities.Deposit", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AmountMoney = 20.0,
                            CustomerId = 1,
                            Date = new DateTime(2024, 7, 15, 23, 41, 4, 819, DateTimeKind.Local).AddTicks(8737),
                            Type = "Khuyen Mai"
                        });
                });
            ...
            modelBuilder.Entity("SWD392.OutfitBox.DataLayer.Entities.Transaction", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amount = 0.0,
                            DateTransaction = new DateTime(2024, 7, 15, 23, 41, 4, 819, DateTimeKind.Local).AddTicks(8706),
                            DepositId = 1,
                            Paymethod = "",
                            Status = 0,
                            WalletId = 1
