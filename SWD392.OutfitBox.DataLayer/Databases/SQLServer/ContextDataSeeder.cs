    ...
    public static class ContextDataSeeder
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            new Product
            {
                ...
                new Product { ID = 19, Name = "Idylls Women's Turban", Price = 80, Size = null, Description = "Popular elements: Flowers Quantity: 1 headscarf + 1 sunglasses", Status = 1, IsUsed = "FALSE", Deposit = 0, IdCategory = 6, Quantity = 20, AvailableQuantity = 20, IdBrand = 6, Type = "New" },
                new Product { ID = 20, Name = "Accessories Square twisted necklaces of all sizes 3mm, 4mm, 5mm, 6mm, 8mm, 10mm", Price = 900, Size = null, Description = "Square twisted wire of all sizes, machine cut, 45cm and 50cm thick", Status = 1, IsUsed = "FALSE", Deposit = 0, IdCategory = 6, Quantity = 20, AvailableQuantity = 20, IdBrand = 6, Type = "New" },
                new Product { ID = 21, Name = "Casio 42.5 mm Men's Watch MTP-M100D-7AVDF", Price = 1500, Size = null, Description = "G-Shock with strong design and high durability, Edifice with modern design and many outstanding features, Sheen with classic and luxurious design.", Status = 1, IsUsed = "FALSE", Deposit = 0, IdCategory = 6, Quantity = 20, AvailableQuantity = 20, IdBrand = 6, Type = "New" },
                new Product { ID = 22, Name = "Citizen 28mm Women's Watch EM0809-83Z", Price = 1500, Size = null, Description = "The main design trend of Citizen watches is simple and elegant.", Status = 1, IsUsed = "FALSE", Deposit = 0, IdCategory = 6, Quantity = 20, AvailableQuantity = 20, IdBrand = 6, Type = "New" },
                new Product { ID = 23, Name = "UV protection sunglasses from NICOLE Korea", Price = 500, Size = null, Description = "Unisex glasses for both men and women Anti-ultraviolet rays, UV400 rays, maximum eye protection", Status = 1, IsUsed = "FALSE", Deposit = 0, IdCategory = 6, Quantity = 20, AvailableQuantity = 20, IdBrand = 6, Type = "New" },
                ...
                new Product { ID = 31, Name = "Korean retro style Small Square Frame Sunglasses", Price = 200, Size = null, Description = "Full rim glasses. Fashion style", Status = 1, IsUsed = "FALSE", Deposit = 0, IdCategory = 6, Quantity = 20, AvailableQuantity = 20, IdBrand = 6, Type = "New" },
                new Product { ID = 32, Name = "Retro fashion cat eye sunglasses for women", Price = 150, Size = null, Description = "100% brand new, high quality", Status = 1, IsUsed = "FALSE", Deposit = 0, IdCategory = 6, Quantity = 20, AvailableQuantity = 20, IdBrand = 6, Type = "New" },
                new Product { ID = 33, Name = "JENNIE sunglasses with Y2K style", Price = 300, Size = null, Description = "100% brand new, high quality", Status = 1, IsUsed = "FALSE", Deposit = 0, IdCategory = 6, Quantity = 20, AvailableQuantity = 20, IdBrand = 6, Type = "New" },
